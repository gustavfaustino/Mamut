...
function App() {
  const [posts, setPosts] = useState([
    {
      ...
      username: "Bookworm 📚",
      userID: "@booklover",
      postContent: "Just finished reading this amazing book! I highly recommend it to everyone who loves a good mystery novel.",
      postImage: "https://images.unsplash.com/photo-1667312939934-60fc3bfa4ec0?q=80&w=1374&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
      postImageALT: "A stack of books on a wooden table",
    },
    //Post 2
    {
      id: 2,
      userIcon: "https://upload.wikimedia.org/wikipedia/en/f/f1/Puffin_Browser_Icon.png",
      username: "Puffin Fan",
      userID: "@puffinbrowserfan",
      postContent: "Look at my birdo friend!",
      postImage: "https://images.unsplash.com/photo-1490718748265-11161b222038?q=80&w=872&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    ...
    {
      id: 4,
      userIcon: "https://avatarfiles.alphacoders.com/747/thumb-350-74790.webp",
      username: "Raposit",
      userID: "@foxlover",
      postContent: "Mai que coisa mais linda :D",
      postImage: "https://images.unsplash.com/photo-1472656877636-35a4bb852385?q=80&w=870&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
  ...
  const handleNewPost = (newPost) => {
    setPosts([newPost, ...posts]); // Adiciona o novo post ao array de posts
  };

  return (
    <div className="App">
      {/* Campo Esquerdo */}
      < LeftSidebar userIcon={UserDryBonesExample} username="Dry Bones" userID="@ihatemp" onPost={handleNewPost} />
      ...
      <div className="Central">
        ...
        {/* Renderizar todos os posts armazenados e novos: */}
        {posts.map((post) => (
          <Post
            key={post.id}
